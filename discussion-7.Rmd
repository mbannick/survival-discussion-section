...
We want to estimate the $\phi$ parameters in the acceleration factor. It turns out that for the Weibull parameterization (includes exponential), $\phi = -\beta$. So HR = 1/acceleration factor from `flexsurvreg` package.
...
With `dist="weibull"` it returns an deceleration factor (so 1/acceleration factor).
