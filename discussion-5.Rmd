...
- Review the relationship between the survival function and the hazard function
...
- 3 Treated left eye in patient 561 aged 15:  $h_0(t) e^{\beta_1 1 + \beta_2 15}$
- 1 Untreated right eye in patient 561 aged 15: $h_0(t) e^{\beta_1 0 + \beta_2 15}$
- 2 Untreated left eye in patient 568 aged 10: $h_0(t) e^{\beta_1 0 + \beta_2 10}$
...
The risk set at second failure time (42.17) includes the remaining two untreated eyes, and the younger aged one failed before the older aged one.

$$
\frac{e^{\beta_1 0 + \beta_2 10}}{e^{\beta_1 0 + \beta_2 15} + e^{\beta_1 0 + \beta_2 10}}
$$
...
= \frac{e^{\beta_1 0 + \beta_2 15}}{e^{\beta_1 1 + \beta_2 15} + e^{\beta_1 0 + \beta_2 15} + e^{\beta_1 0 + \beta_2 10}}
 \times \frac{e^{\beta_1 0 + \beta_2 10}}{e^{\beta_1 0 + \beta_2 15} + e^{\beta_1 0 + \beta_2 10}}
$$
